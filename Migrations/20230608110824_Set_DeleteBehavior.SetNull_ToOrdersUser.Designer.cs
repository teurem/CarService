...
namespace digitization.Migrations
{
    ...
    [Migration("20230608110824_Set_DeleteBehavior.SetNull_ToOrdersUser")]
    partial class SetDeleteBehaviorSetNullToOrdersUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("digitization.Models.Point", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 101L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3610),
                            Name = "в обработке"
                        },
                        new
                        {
                            Id = 102L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3612),
                            Name = "в процессе"
                        },
                        new
                        {
                            Id = 103L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3613),
                            Name = "завершен"
                        });
                });
            ...
            modelBuilder.Entity("digitization.Models.Reason", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1001L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3639),
                            Name = "принять заказ"
                        },
                        new
                        {
                            Id = 1002L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3640),
                            Name = "добавить запчасти"
                        },
                        new
                        {
                            Id = 1003L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3641),
            ...
            modelBuilder.Entity("digitization.Models.RoadMap", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3652),
                            ReasonId = 1001L,
                            SourcePointId = 101L,
                            TargetPointId = 102L
                        },
                        ...
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2023, 6, 8, 11, 8, 24, 786, DateTimeKind.Utc).AddTicks(3654),
                            ReasonId = 1002L,
                            SourcePointId = 102L,
                            TargetPointId = 102L
                        },
